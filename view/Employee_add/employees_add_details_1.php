                            ...
                            <table class="table table-bordered table-condensed" style="border: black solid">
                                <thead>
                                    <tr style="background-color: #DDD; border-bottom: black solid;">
                                        <th>a. Employee Personal Details</th>
                                    </tr>   
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <form name="add_emp_personal_details" id="add_emp_personal_details" method="post" action="../controller/controller_employee.php?action=addEmpPersonalDetails">
                                                <div class="row">
                                                    <div class="col-md-5"><h4>Title</h4></div>
                                                    <div class="col-md-2">
                                                        <select name="title" id="title" class="form form-control">
                                                            <option></option>
                                                            <option>Mr.</option>
                                                            <option>Mrs.</option>
                                                            <option>Ms.</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5"><h4>Address</h4></div>
                                                    <div class="col-md-7">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5"><h4>Date of Birth</h4></div>
                                                    <div class="col-md-7">
