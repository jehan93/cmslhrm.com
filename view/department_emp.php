...
$resultDeptInfo=$obdept->viewDepartmentInfo($deptId);
$deptInfo = $resultDeptInfo->fetch(PDO::FETCH_BOTH);
$deptName = $deptInfo['dept_name'];
$deptHeadEmpId = $deptInfo['dept_head_emp_id'];

$result1DeptManager=$obdept->viewDepartmentManagers($deptId);
$deptManagersInfo = $result1DeptManager->fetch(PDO::FETCH_BOTH);
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:25%; vertical-align: text-top ">Role</th>
                                        <th style="width:35%; vertical-align: text-top "></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                   ...
                                   <tr>
                                        ...
                                        <td><?php if ($deptHeadEmpId==$deptEmp['dept_emp_id']) {
