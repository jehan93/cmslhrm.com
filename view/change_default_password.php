        ...
        <div id="main">
            ...
            <div class="row">
                <div id="content" class="container col-md-12">
                    ...
                    <div id="error" class="alert alert-danger col-md-12 msgboxtext">
                        You have logged in using a <b>DEFAULT PASSWORD.</b> Please enter a new password to proceed.
                    </div>
                        <?php 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 bborder" 
                             style="font-size: 18px; padding-bottom: 10px; border-radius: 5px; background-color: rgba(160,0,0); color: white; box-shadow: -8px 8px 10px 1px rgba(0,0,0,.5);">
